...
const JobItem = ({
  ...
  return (
    <div className="group relative ml-1 flex items-center justify-between md:ml-0 md:justify-normal md:odd:flex-row-reverse">
      <div className="flex size-8 shrink-0 items-center justify-center rounded-full bg-danger text-slate-50 shadow md:order-1 md:size-10 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2"></div>
      <TimelineItemCard
        title={employer}
        subtitle={position}
        startDate={startDate}
